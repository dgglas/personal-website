...
### \* Omnifood features - below pricing cards
...
- How it works: How Omnifood works
- Diets/Meals: Sample meals; Works with any diet
- Testimonials/Gallery: Customer testimonials; Photo gallery
- Pricing/Features: Omnifood Featres; Free meal; Pricing plans
- Call to Action: Signup form
- Footer: Contact information; Additional links
